...
One predecessor's experience made that line look right; the direction
...
express the same semantic (the predecessor's §11 discipline), and only if the core stays
