...
<p align="center"><b>v0.41.1</b> · MIT · Node ≥ 22 · <a href="https://kiso.work">kiso.work</a> · <a href="README.md">English edition</a></p>
...
- **小而透明。** 内核上限 2,200 行（现在 2,189 行），超了就不合并；会话就是一份可以直接读的 JSONL 日志；每个设计决定都记在 42 份 ADR 里，写明为什么这样做、什么情况下该推翻它。
