...
<p align="center"><b>v0.40.0</b> · MIT · Node ≥ 22 · <a href="https://kiso.work">kiso.work</a> · <a href="README.zh.md">Chinese edition</a></p>
...
this directory; tab shows every session, each tagged with where it started. Each row SAYS the state
kiso will resume into, in words, read from the session's own durable log:
...
(ADR-0043). The core sits at **2,183 of 2,200** lines today. The product
