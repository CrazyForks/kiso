...
- **Small and inspectable.** The kernel is capped at 2,200 lines (2,179 of 2,200 today); a session is a JSONL log you can read; every design decision is one of 42 ADRs, with why, and when to overturn it.
